...
#define LOGFMTT(...) \
        stdxx::log::print(stdxx::log::Trace, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)

#define LOGFMTI(...) \
        stdxx::log::print(stdxx::log::Info, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)

#define LOGFMTE(...) \
        stdxx::log::print(stdxx::log::Error, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)

#define LOGFMTW(...) \
        stdxx::log::print(stdxx::log::Warn, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
